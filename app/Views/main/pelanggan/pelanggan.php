              ...
              <table class="table datatable" id="mitraTable">
                <thead>
                  <tr style="font-weight: bold; color: black; font-size: larger;">
                    ...
                    <td align="center" scope="col">Kode Pelanggan</td>
                    <td align="center" scope="col">Nama </td>
                    <td align="center" scope="col">Nama Orangtua</td>
                    <td align="center" scope="col">Alamat</td>
                    <td align="center" scope="col">Nomor telephone</td>
...
?>
      <tr class="table-row" data-class="<?= $key->class ?>" data-angkatan="<?= $key->angkatan ?>">
        <td align="center" scope="col"><?= $no++ ?></td>
        <td align="center" scope="col"><?= $key->KodePelanggan ?></td>
        <td align="center" scope="col"><?= $key->NamaPelanggan ?></td>
        <td align="center" scope="col"><?= $key->NamaOrangtua ?></td>
        <td align="center" scope="col"><?= $key->Alamat ?></td>
        <td align="center" scope="col"><?= $key->NomorTelepon ?></td>
        <td align="center" scope="col">
          <div style="display: flex; gap: 10px; justify-content: center;">
            <a class="btn btn-danger" href="<?= base_url('home/DelPe/'.$key->PelangganID ) ?>">Delete</a>
            <a class="btn btn-warning" href="<?= base_url('home/UpPe/'.$key->PelangganID) ?>">Edit</a>
          </div>
        </td>
      </tr>
<?php
